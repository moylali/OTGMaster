package com.otgmaster.provider
...
class VeraCryptDocumentProvider : DocumentsProvider() {
    ...
    companion object {
        private const val AUTHORITY = "com.otgmaster.documents"
    ...
    override fun queryRoots(projection: Array<out String>?): Cursor {
        ...
        if (fs != null) {
            ...
            row.add(DocumentsContract.Root.COLUMN_ICON, com.otgmaster.R.mipmap.ic_launcher)
        }
